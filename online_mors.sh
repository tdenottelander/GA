...
optimizer="MO-RS"
CUDA_VISIBLE_DEVICES=$gpu $path_to_executable -S $seed -P $path_to_project -d $dataset -f $fit -o $optimizer -r $repetitions -I 0 -M $populationInitializationMode -q $printAtEveryEval -x $saveLogFilesOnEveryUpdate -O "MO-RS_run$run""_seed$seed"
