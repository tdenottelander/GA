...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ga

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ga: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ga ${OBJECTFILES} ${LDLIBSOPTIONS} -larmadillo -lpython3.6m

${OBJECTDIR}/src/Analysis/GreedyAnalysis.o: src/Analysis/GreedyAnalysis.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Analysis
	${RM} "$@.d"
	$(COMPILE.cc) -g -Idependencies/json/include -Isrc/Analysis -Isrc/FOS -Isrc/Fitness -Isrc/GA -Isrc/Individual -Isrc/MO-GOMEA -Isrc/Util -Isrc/Variation -Isrc/Fitness/ARK -Isrc/Fitness/MO -Idependencies/armadillo-9.850.1/include -Isrc/Selection -I/usr/include/python3.6m -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Analysis/GreedyAnalysis.o src/Analysis/GreedyAnalysis.cpp
...
${OBJECTDIR}/src/FOS/FOS.o: src/FOS/FOS.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Idependencies/json/include -Isrc/Analysis -Isrc/FOS -Isrc/Fitness -Isrc/GA -Isrc/Individual -Isrc/MO-GOMEA -Isrc/Util -Isrc/Variation -Isrc/Fitness/ARK -Isrc/Fitness/MO -Idependencies/armadillo-9.850.1/include -Isrc/Selection -I/usr/include/python3.6m -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FOS/FOS.o src/FOS/FOS.cpp
...
${OBJECTDIR}/src/Fitness/NK.o: src/Fitness/NK.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Fitness
	${RM} "$@.d"
	$(COMPILE.cc) -g -Idependencies/json/include -Isrc/Analysis -Isrc/FOS -Isrc/Fitness -Isrc/GA -Isrc/Individual -Isrc/MO-GOMEA -Isrc/Util -Isrc/Variation -Isrc/Fitness/ARK -Isrc/Fitness/MO -Idependencies/armadillo-9.850.1/include -Isrc/Selection -I/usr/include/python3.6m -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Fitness/NK.o src/Fitness/NK.cpp
...
${OBJECTDIR}/src/Fitness/Trap.o: src/Fitness/Trap.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Fitness
	${RM} "$@.d"
	$(COMPILE.cc) -g -Idependencies/json/include -Isrc/Analysis -Isrc/FOS -Isrc/Fitness -Isrc/GA -Isrc/Individual -Isrc/MO-GOMEA -Isrc/Util -Isrc/Variation -Isrc/Fitness/ARK -Isrc/Fitness/MO -Idependencies/armadillo-9.850.1/include -Isrc/Selection -I/usr/include/python3.6m -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Fitness/Trap.o src/Fitness/Trap.cpp

${OBJECTDIR}/src/GA/GA.o: src/GA/GA.cpp
	${MKDIR} -p ${OBJECTDIR}/src/GA
	${RM} "$@.d"
	$(COMPILE.cc) -g -Idependencies/json/include -Isrc/Analysis -Isrc/FOS -Isrc/Fitness -Isrc/GA -Isrc/Individual -Isrc/MO-GOMEA -Isrc/Util -Isrc/Variation -Isrc/Fitness/ARK -Isrc/Fitness/MO -Idependencies/armadillo-9.850.1/include -Isrc/Selection -I/usr/include/python3.6m -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GA/GA.o src/GA/GA.cpp

${OBJECTDIR}/src/GA/GOM.o: src/GA/GOM.cpp
	${MKDIR} -p ${OBJECTDIR}/src/GA
	${RM} "$@.d"
	$(COMPILE.cc) -g -Idependencies/json/include -Isrc/Analysis -Isrc/FOS -Isrc/Fitness -Isrc/GA -Isrc/Individual -Isrc/MO-GOMEA -Isrc/Util -Isrc/Variation -Isrc/Fitness/ARK -Isrc/Fitness/MO -Idependencies/armadillo-9.850.1/include -Isrc/Selection -I/usr/include/python3.6m -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GA/GOM.o src/GA/GOM.cpp

${OBJECTDIR}/src/GA/GOM_LS.o: src/GA/GOM_LS.cpp
	${MKDIR} -p ${OBJECTDIR}/src/GA
	${RM} "$@.d"
	$(COMPILE.cc) -g -Idependencies/json/include -Isrc/Analysis -Isrc/FOS -Isrc/Fitness -Isrc/GA -Isrc/Individual -Isrc/MO-GOMEA -Isrc/Util -Isrc/Variation -Isrc/Fitness/ARK -Isrc/Fitness/MO -Idependencies/armadillo-9.850.1/include -Isrc/Selection -I/usr/include/python3.6m -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GA/GOM_LS.o src/GA/GOM_LS.cpp
...
${OBJECTDIR}/src/GA/MO_LS.o: src/GA/MO_LS.cpp
	${MKDIR} -p ${OBJECTDIR}/src/GA
	${RM} "$@.d"
	$(COMPILE.cc) -g -Idependencies/json/include -Isrc/Analysis -Isrc/FOS -Isrc/Fitness -Isrc/GA -Isrc/Individual -Isrc/MO-GOMEA -Isrc/Util -Isrc/Variation -Isrc/Fitness/ARK -Isrc/Fitness/MO -Idependencies/armadillo-9.850.1/include -Isrc/Selection -I/usr/include/python3.6m -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GA/MO_LS.o src/GA/MO_LS.cpp

${OBJECTDIR}/src/GA/MO_RS.o: src/GA/MO_RS.cpp
	${MKDIR} -p ${OBJECTDIR}/src/GA
	${RM} "$@.d"
	$(COMPILE.cc) -g -Idependencies/json/include -Isrc/Analysis -Isrc/FOS -Isrc/Fitness -Isrc/GA -Isrc/Individual -Isrc/MO-GOMEA -Isrc/Util -Isrc/Variation -Isrc/Fitness/ARK -Isrc/Fitness/MO -Idependencies/armadillo-9.850.1/include -Isrc/Selection -I/usr/include/python3.6m -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GA/MO_RS.o src/GA/MO_RS.cpp

${OBJECTDIR}/src/GA/NSGA_II.o: src/GA/NSGA_II.cpp
	${MKDIR} -p ${OBJECTDIR}/src/GA
	${RM} "$@.d"
	$(COMPILE.cc) -g -Idependencies/json/include -Isrc/Analysis -Isrc/FOS -Isrc/Fitness -Isrc/GA -Isrc/Individual -Isrc/MO-GOMEA -Isrc/Util -Isrc/Variation -Isrc/Fitness/ARK -Isrc/Fitness/MO -Idependencies/armadillo-9.850.1/include -Isrc/Selection -I/usr/include/python3.6m -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GA/NSGA_II.o src/GA/NSGA_II.cpp
...
${OBJECTDIR}/src/GA/SimpleGA.o: src/GA/SimpleGA.cpp
	${MKDIR} -p ${OBJECTDIR}/src/GA
	${RM} "$@.d"
	$(COMPILE.cc) -g -Idependencies/json/include -Isrc/Analysis -Isrc/FOS -Isrc/Fitness -Isrc/GA -Isrc/Individual -Isrc/MO-GOMEA -Isrc/Util -Isrc/Variation -Isrc/Fitness/ARK -Isrc/Fitness/MO -Idependencies/armadillo-9.850.1/include -Isrc/Selection -I/usr/include/python3.6m -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GA/SimpleGA.o src/GA/SimpleGA.cpp
...
${OBJECTDIR}/src/Util/Utility.o: src/Util/Utility.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Util
	${RM} "$@.d"
	$(COMPILE.cc) -g -Idependencies/json/include -Isrc/Analysis -Isrc/FOS -Isrc/Fitness -Isrc/GA -Isrc/Individual -Isrc/MO-GOMEA -Isrc/Util -Isrc/Variation -Isrc/Fitness/ARK -Isrc/Fitness/MO -Idependencies/armadillo-9.850.1/include -Isrc/Selection -I/usr/include/python3.6m -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Util/Utility.o src/Util/Utility.cpp
...
${OBJECTDIR}/src/main.o: src/main.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Idependencies/json/include -Isrc/Analysis -Isrc/FOS -Isrc/Fitness -Isrc/GA -Isrc/Individual -Isrc/MO-GOMEA -Isrc/Util -Isrc/Variation -Isrc/Fitness/ARK -Isrc/Fitness/MO -Idependencies/armadillo-9.850.1/include -Isrc/Selection -I/usr/include/python3.6m -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.cpp
