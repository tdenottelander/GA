...
void MAXCUT::setTrueParetoFront(){
    ...
    string filename = Maxcutmap::benchmarkfolder + "maxcut_pareto_front_" + to_string(totalProblemLength) + ".txt";
...
const string Maxcutmap::benchmarkfolder = "/Users/tomdenottelander/Stack/#CS_MASTER/Afstuderen/projects/Benchmarks/maxcut/";
...
string Maxcutmap::getFilename(int problemsize, int objective){
    return (benchmarkfolder + "maxcut_instance_" + to_string(problemsize) + "_" + to_string(objective) + ".txt");
}
