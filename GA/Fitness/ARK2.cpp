...
ARK2::ARK2() : ARK(13, -1, ark2_optima[13]) {}

ARK2::ARK2(int problemSize, bool allowIdentityLayers, int maxEvaluations) : ARK(problemSize, maxEvaluations, ark2_optima[problemSize]) {
