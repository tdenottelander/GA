...
ARK1::ARK1() : ARK(7, true, -1, ark1_optima[7], getProblemType(true), 3, 7, "ark1") {}

ARK1::ARK1(int problemSize, bool allowIdentityLayers, int maxEvaluations) : ARK(problemSize, allowIdentityLayers, maxEvaluations, ark1_optima[problemSize], getProblemType(allowIdentityLayers), 3, 7, "ark1") {}
